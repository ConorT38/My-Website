...
';
        ...
        $email_headers = "From: $name <info@conorthompson.ie>\r\n";
        ...
        if (mail($recipient, $subject, $email_content,$email_headers)) {
            ...
            $_SESSION['result'] = "Thank You! Your message has been sent.";
			...
			if (mysqli_connect_errno())
             ...
             $sql ="INSERT INTO `db1410151_Conor_thompson`.`stats_emails` ( `email`, `time`) VALUES ('$emailenc', NOW())";
        ...
        $_SESSION['result'] = "There was a problem with your submission, please try again.";
        header("Location: ../#contact");
            die;
    }
